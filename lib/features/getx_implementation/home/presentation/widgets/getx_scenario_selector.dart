...
class GetXScenarioSelector extends StatefulWidget {
  ...
  @override
  State<GetXScenarioSelector> createState() => _GetXScenarioSelectorState();
}

class _GetXScenarioSelectorState extends State<GetXScenarioSelector> {
          ...
          child: InkWell(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color:
                    isSelected ? Colors.purple.withOpacity(0.05) : Colors.white,
                border: Border.all(
  ...
  Widget _buildScenarioTile(
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        trailing: isSelected
            ? Icon(Icons.check_circle, color: Colors.purple[600])
            : null,
